        ...
        #thus begins at n = 3 (at one everything cancels, leaving X).
...
main:
        ...
        mov.d $f12,$f0                  #We set our initial values to the
        mov.d $f2,$f0                   #the point in the summation s.t. i = 3,
        mov.d $f2,$f0                   #this it is necessary to "seed" the loop
